...
const INDICATOR_MESSAGES = {
    not_running: translate('block.binarytool.site is not running.'),
    starting: translate('block.binarytool.site is starting...'),
    running: translate('block.binarytool.site is running...'),
    stopping: translate('block.binarytool.site is stopping...'),
    stopped: translate('block.binarytool.site has stopped.'),
};
