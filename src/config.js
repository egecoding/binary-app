...
const getConfig = () => ({
    ...
    analysis_tool_chart: {
        ...
        label: translate('Free Analysis Tool'),
    },
    robot_tool_chart: {
        visible: true,
        // URL to the chart
        url: 'https://robot.binarytool.site/',
        label: translate('AI Robot'),
    },
    login: {
    ...
    signup: {
        ...
        url: `https://track.deriv.com/_2yZaBZhr48dMjdsyM5hasGNd7ZgqdRLk/1/`,
