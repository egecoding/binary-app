    ...
    <div className='logout-dialog'>
        {is_bot_running ? (
            <div className='logout-dialog__warning-text'>
                <p>
                    {translate(
                        'Binary Bot will not place any new trades. Any trades already placed (but not expired) will be completed by our system. Discarding unsaved changes will result in their loss.'
                    )}
                </p>
                <p>
                    {translate(
